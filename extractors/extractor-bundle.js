// ============================================================
//  extractor-bundle.js — Provider dosyalarına gömülmek üzere
//  kısaltılmış extractor bundle.
//
//  Nuvio plugin'leri lokal require() yapamaz (sadece cheerio-without-node-native,
//  crypto-js, axios desteklenir). Bu yüzden her provider dosyasına bu kod
//  kopyalanır. Provider'ın getStreams fonksiyonu embed URL'leri döndüğü
//  yerde extractStream çağrılır, gerçek stream URL'leri elde edilir.
//
//  Kullanım:
//    // Provider'ın sonuna bu dosyanın içeriğini kopyala
//    // getStreams içinde:
//    var embedUrls = [...];  // provider'ın bulduğu embed URL'ler
...
if (typeof module !== 'undefined' && module.exports) {
  ...
  global.extractAllStreams = extractAllStreams;
}
